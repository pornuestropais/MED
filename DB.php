<?php
	...
	require_once "ConexionDB.php";
			$conexion->query("
		CREATE TABLE IF NOT EXISTS `_MED`.`Persona` (
		...
		-- -----------------------------------------------------
		-- Table `_MED`.`Nutricion`
		-- -----------------------------------------------------
		CREATE TABLE IF NOT EXISTS `_MED`.`Nutricion` (
		...
		-- -----------------------------------------------------
		-- Table `_MED`.`Estomatologia`
		-- -----------------------------------------------------
		CREATE TABLE IF NOT EXISTS `_MED`.`Estomatologia` (
		...
		-- -----------------------------------------------------
		-- Table `_MED`.`TerapiaFisica`
		-- -----------------------------------------------------
		CREATE TABLE IF NOT EXISTS `_MED`.`TerapiaFisica` (
		...
		-- -----------------------------------------------------
		-- Table `_MED`.`Estacion1`
		-- -----------------------------------------------------
		CREATE TABLE IF NOT EXISTS `_MED`.`Estacion1` (
		...
		-- -----------------------------------------------------
		-- Table `_MED`.`Estacion2`
		-- -----------------------------------------------------
		CREATE TABLE IF NOT EXISTS `_MED`.`Estacion2` (
		...
		-- -----------------------------------------------------
		-- Table `_MED`.`Estacion3`
		-- -----------------------------------------------------
		CREATE TABLE IF NOT EXISTS `_MED`.`Estacion3` (
		...
		-- -----------------------------------------------------
		-- Table `_MED`.`Estacion4`
		-- -----------------------------------------------------
		CREATE TABLE IF NOT EXISTS `_MED`.`Estacion4` (
