...
<html lang="en">
  ...
  <body>
    <div class="container" style="margin-top: 20px;">
      <div class="row">
        <div class="col-md-12">
          <form method="post" action="<?php echo $direccion; ?>procesarEstacion3.php" >
           ...
           <div class="form-group">
            ...
            <div class="form-group">
              <label>Glucometr&iacute;a</label>
              <input placeholder="Escribir aqu&iacute; los niveles de glucosa de la persona..." type="text" class="form-control" name="glucometria" required value="<?php echo $Obtener[ 'glucometria' ]; ?>"/>
            </div>
